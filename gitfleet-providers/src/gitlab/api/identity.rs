...
impl IdentityApi {
    ...
    pub async fn add_gpg_key(
        ...
        let body = serde_json::json!({ "key": armored_key });
...
mod tests {
    ...
    #[test]
    fn test_normalize_gitlab_ssh_key_full() {
        ...
        assert_eq!(result.title, "My SSH Key");
        assert_eq!(result.key, "ssh-ed25519 AAAAC3...");

        assert_eq!(result.created_at, "2024-03-01T00:00:00Z");
    }

    #[test]
    fn test_normalize_gitlab_ssh_key_minimal() {
    ...
    #[test]
    fn test_normalize_gitlab_gpg_key_full() {
        let json = serde_json::json!({
            "id": 10,
        ...
        assert_eq!(result.key_id, "DEF456");

        assert_eq!(result.created_at, "2024-04-01T00:00:00Z");
    }

    #[test]
    fn test_normalize_gitlab_gpg_key_minimal() {
        let json = serde_json::json!({});
