...
pub const GITFLEET_HOME_ENV: &str = "GITFLEET_HOME";
pub const GITFLEET_CI_ENV: &str = "GITFLEET_CI";
pub const GITFLEET_LOG_ENV: &str = "GITFLEET_LOG";
pub const GITFLEET_NO_COLOR_ENV: &str = "GITFLEET_NO_COLOR";
pub const GITFLEET_TERM_ENV: &str = "GITFLEET_TERM";
pub const GITFLEET_COLORTERM_ENV: &str = "GITFLEET_COLORTERM";
pub const GITFLEET_COLORFGBG_ENV: &str = "GITFLEET_COLORFGBG";
